...
<div class="section">
    ...
    Nuestro equipo está formado por individuos de todas las areas del campus de MIT y cuenta con el respaldo de un directorio experimentado.
    </div>
...
<div class="row team-row text-center">
    ...
    <div class="team col-md-4">
        <a href="#teamAditiGupta">
            <img class="team-picture" src="images/team/Aditi.jpg"></a>
            ...
            <img class="team-picture" src="images/team/Kiran.jpg"></a>
            <div class="team-name">Kiran Wattamwar</div>
            <div class="team-role">Co-Director</div>
            <div class="team-area">Harvard GSD and Harvard SEAS</div>
